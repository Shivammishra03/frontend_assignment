<template>
    <div class="featured-product-main-outer-sec">
        <div class="featured-product-sec" v-for="(tshirt, index) in featuredTshirtData" :key="index">
            ...
            <div class="product-size-sec">
                <div class="small" v-for="size in tshirt.sizes" :key="size">{{ size }}</div>
            </div>
        </div>
    </div>
    <div class="view-all-btn">
        <button class="view-all-btn-text">VIEW ALL</button>
    </div>
</template>
...
.featured-product-main-outer-sec {
